...
sudo virsh destroy edpm-compute-${EDPM_COMPUTE_SUFFIX} || true
sudo virsh undefine edpm-compute-${EDPM_COMPUTE_SUFFIX} ||true 
rm -f ${HOME}/.crc/machines/crc/edpm-compute-${EDPM_COMPUTE_SUFFIX}.qcow2
rm -f ../out/edpm/edpm-compute-*-id_rsa.pub
oc delete --ignore-not-found=true -f ../out/edpm/dataplane-ansible-ssh-private-key-secret.yaml
